...
DEVICE_PACKAGE_OVERLAYS += device/asus/tf300tg/overlay

# Prebuilt kernel location
ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/asus/tf300tg/kernel
else
...
PRODUCT_PROPERTY_OVERRIDES += \
    ro.epad.model=TF300TG \
    ro.product.model=TF300TG
...
PRODUCT_NAME := full_tf300tg
PRODUCT_DEVICE := tf300tg
PRODUCT_MODEL := tf300tg
PRODUCT_BRAND := asus
